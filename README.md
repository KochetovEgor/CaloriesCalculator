...
Сервис написан с применением чистой архитектуры, в нём выделены основные слои: domain, service, storage, controller, DTO. В сервисе реализовано логирование с помощью пакета "log/slog" и аутентификация пользователей с помощью JWT.
